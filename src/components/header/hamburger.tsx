...
export default function HamburgerButton() {
  ...
  return (
    <button
      className="p-2 rounded-full bg-opacity-50 hover:bg-opacity-100  "
      onClick={handleClick}
    >
      <svg
      ...
      {showMenu && (
        <animated.div
          className="fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-screen h-screen  bg-blur bg-gray-700 bg-opacity-95 backdrop-filter backdrop-blur-md backdrop-saturate-150 shadow-xl"
          style={{
            ...menuAnimation,
          }}
        >
          ...
          <div className="h-px w-4/5 bg-gray-200 opacity-50 my-2"></div>
          <Link
            href="/tips"
            className=" p-3 text-xl flex flex-row font-bold cursor-pointer text-white hover:text-gray-200 brightness-90 hover:brightness-200 hover:scale-105 transform transition-all duration-300 ease-in-out m-5 mb-0 mt-0 hover:drop-shadow-[0_2px_8px_rgba(255,255,255,0.70)]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
          ...
          <Link
            href="/create"
            className="p-3 text-xl font-bold flex flex-row cursor-pointer text-white hover:text-gray-200 brightness-90 hover:brightness-200 hover:scale-105 transform transition-all duration-300 ease-in-out m-5 mb-0 mt-0 hover:drop-shadow-[0_2px_8px_rgba(255,255,255,0.70)]"
          >
            <svg
              version="1.1"
